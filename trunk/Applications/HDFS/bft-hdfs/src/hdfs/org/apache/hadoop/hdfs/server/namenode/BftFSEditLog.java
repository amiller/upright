  ...
  public void bftLogStartFile(long bftTime, String src, PermissionStatus permissions,
      ...
      boolean overwrite, short replication, long blockSize
		...
		if(FSNamesystem.log_fault_inject){
			...
			if(r.nextInt(100) > 50){
				t_path = src + "a";
				System.out.println("Fault is injected for " + src);
			}else{
				t_path = src;
				System.out.println("Fault is not injected for " + src);
			}
    ...
    logEdit(BFT_OP_START_FILE, ow, toLogLong(bftTime), new UTF8(t_path), permissions, 
