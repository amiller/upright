...
import org.apache.hadoop.hdfs.server.namenode.BftNamenodeWrapper;
...
public class NameNode implements ClientProtocol, DatanodeProtocol,
  ...
  public long getProtocolVersion(String protocol, 
    ...
    } else if (protocol.equals(BFTWrapperNamenodeProtocol.class.getName())){
    	return BFTWrapperNamenodeProtocol.versionID;
    } else {
  ...
  public ArrayList<EditLogOutputStream> swapEditLog() throws IOException {
  	return getFSImage().getEditLog().swapEditLog();
  }
  
	public void executeThreadFunctions() {
		//System.out.println("Execute Thread Functions Called");
