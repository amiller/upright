...
public class BFTBlockSender extends BlockSender{
	...
	private DataInputStream mdIn; // md5 stream
	...
	BFTBlockSender(Block block, long startOffset, long length,
      ...
      if (startOffset < 0 || startOffset > endOffset
    	...
    	//int packetSize = 64*1024; // 64k  	
      //int chunkSize = checksum.getBytesPerChecksum() + checksum.getChecksumSize();
      //int n = DataNode.PKT_HEADER_LEN + SIZE_OF_INTEGER;
      //int chunksPerPacket = Math.max((packetSize - n + chunkSize-1)/chunkSize, 1);
      int bytesPerPacket = 64*1024;//checksum.getBytesPerChecksum()*chunksPerPacket;
