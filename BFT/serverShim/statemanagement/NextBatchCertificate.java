...
// 	if (val!=null)
// 	    BFT.Debug.println("\t\t"+val.getSeqNo()+" spec: "+
...
// 	System.out.println("\t    to "+val + " "+((val==null)?null:val.getTag()));
	...
	if (val != null && val.matches(rep)){
	    ...
	    if (rep.getTag() == 13){
// 	    	System.out.println("\t\tadding "+rep.getTag() +" for "+rep.getSeqNo());
...
// 	    else
// 		System.out.println("\t\t"+val.getSeqNo()+" batch not yet complete");
	    return false;
	}
...
// 		    }
// 		    tmp = tmp +"}";
// 		    System.out.println("\t\t"+val.getSeqNo()+" missing commands: "+tmp);
// 	}
	return res;
    }
